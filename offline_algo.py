...
def init_from_file(file_name:str):
    with open(file_name, 'r') as file:
        ...
        for row in reader:
            list.append(row)
    return list
# init csv file for the allocate function
...
# calculate the distance between src and dest of the elevator
...
def allocate(filename: str):
    ...
    return csvwrite
#allocate each call an elevator

if __name__ == '__main__':
    b = input("please enter a string of the building:")
    a = input("please enter a string of the calls:" )
    c = input("please enter a string of the output:")
    init_from_json(a)
    c = allocate(b)
